            ...
            <div class="panel panel-bd lobidrag">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="first_name" class="form-control" type="text" placeholder="<?php echo display('first_name') ?>" id="first_name"   value="<?php echo $data->first_name;?>">
                            </div>
                             <label for="second_name" class="col-sm-2 col-form-label"><?php echo display('second_name') ?> *</label>
                            <div class="col-sm-4">
                                <input name="second_name" class="form-control" type="text" placeholder="<?php echo display('second_name') ?>" id="second_name"  value="<?php echo $data->second_name;?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                             ...
                             <label for="document_id" class="col-sm-2 col-form-label"><?php echo display('document_id') ?></label>
                            <div class="col-sm-4">
                                <input name="document_id" class="form-control" type="text" placeholder="<?php echo display('document_id') ?>" id="agent_document_id"  value="<?php echo $data->document_id;?>">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                             ...
                             <label for="document_pic" class="col-sm-2 col-form-label"><?php echo display('document_pic') ?> </label>
                            <div class="col-sm-4">
                        ...
                        <label for="phone_no" class="col-sm-2 col-form-label"><?php echo display('phone_no') ?> *</label>
                            <div class="col-sm-4">
                                <input name="phone_no" class="form-control" type="text" placeholder="<?php echo display('phone_no') ?>" id="phone_no"  value="<?php echo $data->phone_no;?>">
                            </div>
                            <label for="email_no" class="col-sm-2 col-form-label"><?php echo display('email_no') ?> </label>
                            <div class="col-sm-4">
                                <input name="email_no" class="form-control" type="email" placeholder="<?php echo display('email_no') ?>" id="email_no"  value="<?php echo $data->email_no;?>">
                            </div>
                             
                        </div>
                        <div class="form-group row">
                        <label for="blood_group" class="col-sm-2 col-form-label"><?php echo display('blood_group') ?> </label>
                            <div class="col-sm-4">
                                <input name="blood_group" class="form-control" type="text" placeholder="<?php echo display('blood_group') ?>" id="blood_group"  value="<?php echo $data->blood_group;?>">
                            </div>
                            <label for="address_line_1" class="col-sm-2 col-form-label"><?php echo display('address_line_1') ?></label>
                            <div class="col-sm-4">
                                <textarea name="address_line_1" class="form-control" placeholder="<?php echo display('address_line_1') ?>" id="address_line_1"><?php echo $data->address_line_1;?></textarea> 
                            </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="col-sm-4">
                                <textarea name="address_line_2" class="form-control" placeholder="<?php echo display('address_line_2') ?>" id="address_line_2"><?php echo $data->address_line_2;?></textarea> 
                            </div><label for="country" class="col-sm-2 col-form-label"><?php echo display('country') ?> </label>
                            <div class="col-sm-4">
...
<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input name="city" class="form-control" type="text" placeholder="<?php echo display('city') ?>" id="city"  value="<?php echo $data->city;?>">
                            </div>
                            <label for="zip" class="col-sm-2 col-form-label"><?php echo display('zip') ?></label>
                            <div class="col-sm-4">
                                <input name="zip" class="form-control" type="text" placeholder="<?php echo display('zip') ?>" id="zip"  value="<?php echo $data->zip;?>">
                            </div>
