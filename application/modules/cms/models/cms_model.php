...
class Cms_model extends CI_Model {
	...
	{
		return $this->db->update('web_footer', $data);
	}
	...
	{
		return $this->db->update('web_hometext', $data);
	}

    public function facilities() 
	{
		// return $this->db->get('ws_setting')->row();
		return $this->db->select('a.*,b.id as id_web,b.title,b.description,b.image')
            ->from('fleet_facilities a')
            ->join('web_facilities b','b.facilities_id = a.id','left')
            ->get()
            ->result();
	}

    public function facilities_single($id) 
	{
		// return $this->db->get('ws_setting')->row();
		return $this->db->select('a.*,b.id as id_web,b.title,b.description,b.image')
            ->from('fleet_facilities a')
    ...
    public function facilities_check($id) 
	{
		// return $this->db->get('ws_setting')->row();
    ...
    public function create_facilities($data)
	{	 
		return $this->db->insert('web_facilities',$data);
	}

    public function update_facilities($data,$id) 
	{
		return $this->db->where('facilities_id', $id)
            ->update('web_facilities', $data);
	}
    ...
    public function update_sosmed($data) 
	{
		return $this->db->update('web_sosmed', $data);
	}
    ...
    public function pointtext_single($id) 
	{
		// return $this->db->get('ws_setting')->row();
		return $this->db->select('*')
            ->from('web_pointtext')
    ...
    public function update_pointtext($data,$id) 
	{
		return $this->db->where('id', $id)
            ->update('web_pointtext', $data);
	}
    ...
    public function fasilitas($judul) 
	{
		// return $this->db->get('ws_setting')->row();
		return $this->db->select('konten')
            ->from('konten_fasilitas')
            ->where('judul', $judul)
            ->get()
            ->row();
	}
	...
	{
		return $this->db->where('judul', $data['judul'])
			->update('konten_fasilitas', ['konten' => $data['konten']]);
	}
