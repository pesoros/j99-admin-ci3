<div class="form-group text-right">
	...
	<a href="<?php echo base_url();?>agent/agent_controller/create_agent"
		class="btn btn-primary"><?php echo display('agent_list') ?></a>
	<?php endif; ?>
</div>
		...
		<div class="panel panel-bd lobidrag">
			...
			<div class="panel-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_first_name" class="form-control" type="text"
							placeholder="<?php echo display('agent_first_name') ?>" id="agent_first_name"
							value="<?php echo $data->agent_first_name;?>">
					</div>
					<label for="agent_second_name" class="col-sm-2 col-form-label">
						<?php echo display('agent_second_name') ?> *</label>
					<div class="col-sm-4">
						<input name="agent_second_name" class="form-control" type="text"
							placeholder="<?php echo display('agent_second_name') ?>" id="agent_second_name"
							value="<?php echo $data->agent_second_name;?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_phone" class="form-control" type="text"
							placeholder="<?php echo display('agent_phone') ?>" id="agent_phone"
							value="<?php echo $data->agent_phone;?>">
					</div>
					<label for="agent_mobile" class="col-sm-2 col-form-label">
						<?php echo display('agent_mobile') ?>
					</label>
					<div class="col-sm-4">
						<input name="agent_mobile" class="form-control" type="text"
							placeholder="<?php echo display('agent_mobile') ?>" id="agent_mobile"
							value="<?php echo $data->agent_mobile;?>">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_company_name" class="form-control" type="text"
							placeholder="<?php echo display('agent_company_name') ?>" id="agent_company_name"
							value="<?php echo $data->agent_company_name;?>">
					</div>
					<label for="agent_document_id" class="col-sm-2 col-form-label">
						<?php echo display('agent_document_id') ?>
					</label>
					<div class="col-sm-4">
						<input name="agent_document_id" class="form-control" type="text"
							placeholder="<?php echo display('agent_document_id') ?>" id="agent_document_id"
							value="<?php echo $data->agent_document_id;?>">
					</div>
				</div>
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_pic_document" class="form-control" type="file"
							placeholder="<?php echo display('agent_pic_document') ?>" id="agent_pic_document">
					</div>
					<label for="agent_picture" class="col-sm-2 col-form-label">
						<?php echo display('agent_picture') ?> </label>
					<div class="col-sm-4">
						<input name="agent_picture" class="form-control" type="file"
							placeholder="<?php echo display('agent_picture') ?>" id="agent_picture">
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_email" class="form-control" type="email"
							placeholder="<?php echo display('agent_email') ?>" id="agent_email"
							value="<?php echo $data->agent_email;?>">
					...
					<div class="col-sm-4">
						<textarea name="agent_address_line_1" class="form-control"
							placeholder="<?php echo display('agent_address_line_1') ?>" id="agent_address_line_1"><?php echo $data->agent_address_line_1;?>
                                </textarea>
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<textarea name="agent_address_line_2" class="form-control"
							placeholder="<?php echo display('agent_address_line_2') ?>" id="agent_address_line_2"><?php echo $data->agent_address_line_2;?>
                                </textarea>
					</div>
					...
					<div class="col-sm-4">
						<select name="agent_country" class="form-control" style="width: 100%">
							...
							<option value="Cuba" rel="" Cuba</option> <option value="Curaco" rel="">Curacao</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_address_city" class="form-control" type="text"
							placeholder="<?php echo display('agent_address_city') ?>" id="agent_address_city"
							value="<?php echo $data->agent_address_city;?>">
					</div>
					<label for="agent_address_zip_code" class="col-sm-2 col-form-label">
						<?php echo display('agent_address_zip_code') ?> </label>
					<div class="col-sm-4">
						<input name="agent_address_zip_code" class="form-control" type="text"
							placeholder="<?php echo display('agent_address_zip_code') ?>" id="agent_address_zip_code"
							value="<?php echo $data->agent_address_zip_code;?>">
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-4">
						<input name="agent_commission" class="form-control" type="text"
							placeholder="<?php echo display('agent_commission'); ?>" id="agent_commission"
							value="<?php echo $data->agent_commission;?>">
					</div>
                    <div for="cash" class="col-sm-2 col-form-div">
                        Pembayaran Cash</div>
                    <div class="col-sm-4">
                        <select name="cashpay" class="form-control" style="width: 100%">
                            <option value="0" rel="" <?php echo $data->cashpay == '0' ? 'selected' : ''?>>Tidak</option>
                            <option value="1" rel="" <?php echo $data->cashpay == '1' ? 'selected' : ''?>>Ya</option>
                        </select>
                    </div>
				</div>
